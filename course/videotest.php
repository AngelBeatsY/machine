...
<head>
	...
	.barrage .screen .mask div{position:relative;font-size:20px;font-weight:bold;white-space:nowrap;line-height:40px;z-index:40;}
...
<body>
	...
	<!-- <div style="height: 480px;width: 720px;background: #666;position:relative;overflow:hidden;"> -->
		<div class="barrage">
			<div class="screen">
			...
			<div class="send">
				...
				<input type="button" class="s_btn btn" value="说两句"/>
			</div>
			<!--Send End-->
			<span class="s_close">X</span>
		</div>
		<a href="#" class="showBarrage btn" style="background: #ccc;margin-left: 50%;">打开弹幕</a>
	<!-- </div> -->
